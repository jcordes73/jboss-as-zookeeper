 ...
 */
public class ZooKeeperSubsystemRemove extends AbstractRemoveStepHandler {
    ...
    public static final ZooKeeperSubsystemRemove INSTANCE = new ZooKeeperSubsystemRemove();
 
    private ZooKeeperSubsystemRemove() {
    }
